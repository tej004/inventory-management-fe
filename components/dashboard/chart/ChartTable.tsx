...
export function ChartTable() {
  ...
  const {
    ...
    queryKey: ['dailyWarehouseSales', startDate, endDate],
    queryFn: () =>
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Warehouse sales</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Daily warehouse sales in stock quantity
          </span>
        ...
        {isLoading ? (
          ...
          <ChartContainer
            config={Object.fromEntries(
              warehouseKeys.map((key) => [key, { label: key }])
            )}
